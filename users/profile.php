...
<html>
    <head>
        ...
        <style>
            ...
            .ErrorContainer {
                ...
                border-radius: 25px; 
                border: 3px solid rgb(222, 125, 125);
            }
        </style>
    ...
    <body>
        ...
        <div style="position:relative;">
            <div class="Container" id="IDTag" style="width:500px; height:200px; margin-left:150px; margin-top:70px; margin-right:60px; display:inline-block;">
                <div style="position:relative; top: 50%; left: 50%; transform: translate(-50%, -50%);">
                    ...
                    <div style="display:inline-block;">
                        ...
                        <form action="/users/upload.php" method="post" enctype="multipart/form-data" id="EditForm">
            ...
            <div class="Container" id="ProfilePostContainer" style="width:1050px; height:700px; margin-top: 70px; display:inline-block; position:fixed;">
                <h1 style="font-family:Montserrat; font-size:30pt; color:black; display:inline-block; margin-left:35px;">posts</h1>
                <hr style="width:90%"/>
                <br/>

                <div class="SubContainer" id="PostConstructor" style="width:95%; height:100px; position:relative; left:50%; transform: translate(-50%, 0%);">
            ...
            <div class="Container" style="width:500px; height:300px; margin-left:150px; margin-right:0; margin-top:35px;">
                ...
                <div style="margin-left:30px; font-family:Montserrat; font-size:16pt;">
                    <?php
                        $Description = preg_replace("/&#?[a-z0-9]+;/i","",$ProfileDetails["Description"]); 
                    ?>
                    <p>Bio: <?php global $ProfileDetails; echo $Description?></p>
